...
class Game1l2Fragment : Fragment(R.layout.fragment_game_1_l_2), LifecycleOwner {
        ...
        when (g1l2ViewModel.gameState.value){
            0, 2 -> {
                binding.g1l1TopTextView.text = getString(R.string.g1l1_remaining,
                    g1l2ViewModel.colorsToBeShown - g1l2ViewModel.counter)
            }
            3 -> {
                binding.g1l1TopTextView.text = getString(R.string.g1l1_remaining,
                    g1l2ViewModel.colorsToBeShown - g1l2ViewModel.inputArray.size)
            }
            4 -> {
    ...
    private fun buttonColorHandler(){
        when (g1l2ViewModel.buttonColor){
            0 -> {
